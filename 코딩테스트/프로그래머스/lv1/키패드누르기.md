...
![image](https://user-images.githubusercontent.com/64582209/156317037-11df7bd0-6a09-4361-8ffa-b6ae94ee4fd0.png)
...
![image](https://user-images.githubusercontent.com/64582209/156317084-296b70eb-76de-4fb9-b04c-5f351d56fe9e.png)
    ...
    public String solution(int[] numbers, String hand) {
        ...
        for(int number : numbers){
            ...
            if(number == 1 || number == 4 || number == 7){
                ...
                int L = number > leftCur ? number - leftCur : leftCur - number;
                int R = number > rightCur ? number - rightCur : rightCur - number;

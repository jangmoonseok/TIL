...
![image](https://user-images.githubusercontent.com/64582209/156316803-ca983332-3c93-4cb7-9dd5-efde24ff5a4d.png)
    ...
    public String solution(String new_id) {
        ...
        if(step7.length() <= 2){
            while(step7.length() < 3){
                String lastChar = Character.toString(step7.charAt(step7.length() - 1));
                step7 += lastChar;
            }
        }

...
```
![캡처](https://user-images.githubusercontent.com/64582209/132013397-aa4d5319-5a41-4f01-b76c-a660ca99c37c.PNG)
```
답 :
<body>
    <span>
        <i>∫</i><sub>0</sub><sup><i>t</i></sup>2<sup>5</sup>×<i>log</i><sub>2</sub>X
    </span>
</body>
```
